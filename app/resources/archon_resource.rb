...
class ArchonResource < ApplicationResource
  ...
  belongs_to :house_one, foreign_key: :house_one_id, resource: HouseResource, scope: -> { House.all }
  belongs_to :house_two, foreign_key: :house_two_id, resource: HouseResource, scope: -> { House.all }
  belongs_to :house_three, foreign_key: :house_three_id, resource: HouseResource, scope: -> { House.all }
end
